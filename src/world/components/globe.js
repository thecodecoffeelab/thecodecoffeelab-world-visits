...
class Globe {
  ...
  _buildMaterial() {
    ...
    globeMaterial.color = new Color(0x3f000f);
    globeMaterial.emissive = new Color(0xe1b0ae);
    globeMaterial.emissiveIntensity = 0.1;
    globeMaterial.shininess = 0.99;
  }
}
